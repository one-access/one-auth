...
public class OAuth2Util {
    ...
    public static CustomAbstractOAuth2UserInfo getOAuth2UserInfo(String registrationId,
        ...
        if (registrationId.equalsIgnoreCase(ProviderEnums.AuthProviderId.google.toString())) {
            return new GoogleCustomAbstractOAuth2UserInfo(attributes);
        } else if (registrationId.equalsIgnoreCase(ProviderEnums.AuthProviderId.facebook.toString())) {
            return new FacebookCustomAbstractOAuth2UserInfo(attributes);
        } else if (registrationId.equalsIgnoreCase(ProviderEnums.AuthProviderId.github.toString())) {
